...
The code also contains a baseline for a Host Guardian Service as this environment is intended to be hosted on Windows Shielded Virtual Machines in a trusted Guarded Fabric. I have also included some baseline configurations for Hypervisor-Protected Code Integrity (HVCI) but it is likely unnecessary for most organizations.
